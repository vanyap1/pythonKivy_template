...
class Gauge(Widget):
    ...
    file_gauge = StringProperty(join(path, "assets/cadran.png"))
    ...
    def _update(self, *args):
        ...
        self._glab.center_y = self._gauge.center_y + (self.size_gauge / 5)
        
        self._meterType.center_x = self._gauge.center_x
        self._meterType.center_y = self._gauge.center_y + (self.size_gauge / 8)
