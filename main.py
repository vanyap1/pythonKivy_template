...
class MainScreen(FloatLayout):
    def __init__(self, **kwargs):
        ...
        ## Server start
        self.server, self.server_thread = start_server_in_thread(remCtrlPort, self.httpServerCbFn, self)
        ...
        self.dashGroup.add_widget(self.analogMetersGroup)
        
        self.add_widget(self.dashGroup)
    ...
    def serverUdpIncomingData(self, data):
        try:
            ...
            self.graph1.add_y_point(json_data['socCurrent'] / 10)
